...
public class DynamoDBRepositoryConfigExtension extends RepositoryConfigurationExtensionSupport {
	...
	public void registerBeansForRoot(BeanDefinitionRegistry registry,
		...
		registry.registerBeanDefinition(this.dynamoDBMapperConfigName, augmentContext(dynamoDBMapperConfigBuilder));
		...
		registry.registerBeanDefinition(this.dynamoDBMapperName, augmentContext(dynamoDBMapperBuilder));
	}
